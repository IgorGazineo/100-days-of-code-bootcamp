...
h1Element2 = document.getElementById("main-heading");
...
let secondParagraphEl = document.querySelector(".second-paragraph");
console.log(secondParagraphEl);

// 5. BONUS TASK: Try changing the text content of the <p> element
//    you selected in (4) and set it to any other text of your choice
secondParagraphEl.textContent = "This was changed by Igor";
