...
const btnElement1 = document.querySelector("button");

//    - Select the second button by using an "id"

const btnElement2 = document.getElementById("second-button");
...
btnElement1.addEventListener("click", outputButton1);
btnElement2.addEventListener("click", outputButton2);
